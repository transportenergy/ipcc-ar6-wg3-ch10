...
LOCAL_DATA = {
    ...
    "AR6 country": "raw/snapshot_ISOs_iamc_ar6_2021_10_14.csv.gz",
    #
    # Internal to iTEM, including unpublished/non-public data. Only public, published
    # data are extracted from these files and included in plots and accompanying data
    # dumps
...
SCALE_CAT_BASE = pd.DataFrame(
    ...
    data=[
        ...
        #
        # Current categorization as of 2021-10-04
        [
            "C1",
            "C1: Below 1.5°C with no or low OS",
            "IAM C1: 1.5°C lo OS",
            "#00b050",
            "#00b050",
        ],
        ...
        ["C3", "C3: Likely below 2°C", "IAM C3: likely 2°C", "#71ebe8", "#10706d"],
...
SCALE_CAT_B = pd.DataFrame(
    ...
    data=[
        ...
        ["C6–8", "C6–8", "IAM C6–8: ≥2.5°C", "purple", "purple"],
    ],
)
...
FINAL = {
    "10.14": {"ids": ["fig9-AR6-world-bw10"]},
    "10.17": {"ids": ["fig9-AR6-world-bw10", "fig10-AR6-world-bw10"]},
